...
const manifest = {
   ...
   */
  name: 'Writify: Enhance tweets, scrape content, and improve Slack messages',
  version: packageJson.version,
  description:
    'Writify enhances tweets, scrapes content, and improves Slack messages with custom agents for better communication.',
  ...
  content_scripts: [
    {
      ...
      matches: ['https://*.twitter.com/*', 'https://*.x.com/*', 'https://*.slack.com/*', 'https://*.reddit.com/*'],
